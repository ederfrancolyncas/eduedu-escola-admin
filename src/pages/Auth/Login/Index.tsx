...
import { Center, Box, Group, TextInput, Button, Image } from "@mantine/core"
    ...
    return (
        <div className="bg--login">
            <Center maw={400} h={800} mx="auto">
                ...
                <Box>
                    <Image maw={240} mx="auto" radius="md" src={logo} alt="Logo EduEdu Escola" />
                    ...
                    <form onSubmit={form.onSubmit((values) => console.log(values))}>
                        ...
                        <Group position="right" mt="md">
                            <Link className="font-white no-decoration" to="/esqueci-a-senha">Esqueci a senha</Link>
                        </Group>
